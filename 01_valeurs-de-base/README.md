...
> [!NOTE]\
> Toutes ces erreurs peuvent vous sembler embêtantes, surtout pendant un
> examen, lorsque le temps est compté. Peut-être serez-vous alors
> tenté·e de les ignorer. On vous rappelle toutefois que Pyret identifie
> des erreurs pour lesquelles votre enseignant·e vous pénaliserait
> normalement. On vous conseille donc de régler celles-ci au fur et à
